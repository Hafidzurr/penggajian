				...
				<form method="POST" action="<?php echo base_url('admin/dataGaji/updateDataAksi') ?>">
					...
					<div class="form-group">
						...
						<input type="text" name="Gaji_Pokok" class="form-control"
							value="<?php echo number_format($g->Gaji_Pokok, 2, ',', '.') ?>" readonly>
					...
					<div class="form-group">
						...
						<input type="text" name="Bonus" class="form-control"
							value="<?php echo number_format($g->Bonus, 2, ',', '.') ?>" readonly>
						<?php echo form_error('Bonus', '<div class="text-small text-danger"></div>') ?>
					</div>

					<div class="form-group">
						<label>PPH 5%</label>
						<input type="text" name="PPH_5" class="form-control"
							value="<?php echo number_format($g->PPH_5, 2, ',', '.') ?>" readonly>
						<?php echo form_error('PPH_5', '<div class="text-small text-danger"></div>') ?>
					</div>

					<div class="form-group">
						<label>Total Gaji</label>
						<input type="text" name="Total_Gaji" class="form-control"
							value="<?php echo number_format($g->Total_Gaji, 2, ',', '.') ?>" readonly>
